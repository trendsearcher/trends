...
for index, row in df.iterrows():
    ...
    tops_height_norm = [x/height_pic for x in tops_height]#/height_pic
    ...
    peaks_height_norm = [x/height_pic for x in peaks_height]#/height_pic
    peaks_HW_ratio_norm = [x*trend_lenght/height_pic for x in peaks_HW_ratio]#*trend_lenght/height_pic
    tops_HW_ratio_norm = [x*trend_lenght/height_pic for x in tops_HW_ratio]#*trend_lenght/height_pic
