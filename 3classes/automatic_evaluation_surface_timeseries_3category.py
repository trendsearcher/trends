...
import math
###############################################################################
input_trend_data = 'C:\\Users\\user_PC\\Desktop\\sber\\normal_trends_outofdublers_norm_TPV_vectors.csv'
input_tick_data = 'C:\\Users\\user_PC\\Desktop\\sber\\pureSBER19.csv'
...
proportion_of_standart_deviation = 0.001
window_in_future = 10
...
#    '''достаю приготовленные оценки мусорности,  
#    масштабирую от 0 до 1'''
#    
#    list1 = np.genfromtxt("C:\\Users\\user_PC\\Desktop\\sber\\samples_rating2.csv", delimiter=',')
#    res = (list1)
...
#trend_data['wasteness'] = pd.Series(fetch_waste_lablings(), index=trend_data.index)#pd.Series(grade_list_segmented_aver, index=trend_data.index)
